          ...
          <div>
            <div className="   w-full relative bg-white transition-all duration-500 ease-out group ">
              ...
              <div className="flex justify-between px-5  py-7 ">
                ...
                <small className="text-muted mt-auto mb-5 text-lg ">$25</small>
              </div>
            </div>
          </div>
          <div>
            <div className="   relative bg-white transition-all duration-500 ease-out group  ">
              ...
              <div className="flex justify-between px-5 py-7">
                ...
                <small className="text-muted mt-auto mb-5 text-lg ">$35</small>
              </div>
            </div>
          </div>
          <div>
            <div className="   relative bg-white transition-all duration-500 ease-out group ">
              ...
              <div className="flex justify-between px-5 py-7">
                ...
                <small className="text-muted mt-auto mb-5 text-lg ">$45</small>
              </div>
            </div>
          </div>
        </div>
